...
#---
@time "Build system" sys = build_brussilator(simplify=false) |> complete
@time "Build ODE problem" prob = ODEProblem(sys, [], 11.5; sparse=true)
@time "Solve the problem" sol = solve(prob, TRBDF2(), saveat=0.1)
